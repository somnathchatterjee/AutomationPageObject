    ...
    public void navigate_To_Live_Bidding_Page(){
        ...
        try {
            ...
            if (loginPage.isRadioButtondisplayed()) {
                ...
                System.out.println("We are going to kickout other user");
                ...
                System.out.println("We are in AdminHome page");
            }
            ...
            System.out.println("We are in Live bidding page");
            for(int i=0;i<=100;i++){
                System.out.println("Bot is ready to bid for all auction");
                checkAuctionForBid();
                System.out.println("Bot submited bid for all auction");
